"""
research-figure-skill :: check_figure.py
========================================
...
def _cli() -> int:
    p = argparse.ArgumentParser(description="research-figure-skill compliance checker")
    ...
    if args.strict and any_fail:
        print("[research-figure-skill] strict mode: at least one FAIL — exit 2")
        return 2
    return 0
